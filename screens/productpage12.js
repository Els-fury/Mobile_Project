...
export default function productpage12({navigation}) {
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%' }}>
          <View style={{ flexDirection: 'column' }}>
            <Text style={{ fontWeight: '400', fontSize: 28, color: 'black' }}>FRENCH</Text>
            <Text style={{ fontWeight: '200', marginBottom: 15, fontSize: 28 }}>CROISSANT</Text>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", width: '100%', height: 40, marginBottom: 20 }}>
          <Text style={{ fontWeight: '500', fontSize: 40 }}><Text style={{ color: "#66b2ff" }}>$</Text>15</Text>
